...
public class acerca_de_nosotros extends TabbedForm {
	...
	/**
	 * Create the tabbed form.
	 */
	public acerca_de_nosotros() {
		// Usar layout absoluto para mantener las posiciones exactas
		setLayout(null);
		...
		ImageIcon originalIcon = new ImageIcon(acerca_de_nosotros.class.getResource("/imagenes/Manitas.png"));
		...
		lblNewLabel_1.setBounds(40, 124, 143, 14);
